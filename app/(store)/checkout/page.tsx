          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-rose-100 shadow-sm p-6 sticky top-28">
                ...
                {form.city.trim().toLowerCase().includes("aligarh") && (
                  <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-2.5 flex items-center gap-2 text-emerald-700 text-xs font-bold">
                    ⚡ Same-day delivery available — you&apos;re in Aligarh!
                  </div>
                )}
